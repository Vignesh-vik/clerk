...
import p1 from "../../../public/transfer-money-abroad-removebg-preview.png"
import p2 from "../../../public/Get-the-best-rate.png"
      ...
      <div className="container grid grid-cols-1 items-center gap-8 md:grid-cols-3">
        ...
        <div className="col-span-1 flex justify-end">
          <img
            ...
            className=" size-64 w-full max-w-[300px] overflow-hidden rounded-xl object-cover"
          />
        </div>
        <div className="col-span-1 flex justify-start">
          <img
            ...
            className=" h-64 w-full max-w-[300px] overflow-hidden rounded-xl object-cover"
          />
        </div>
      </div>
    </section>
